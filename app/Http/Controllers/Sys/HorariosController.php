...
class HorariosController extends Controller
{
	...
	public function registrar(Request $request)
	{
		...
		if(!empty($dados['gdh_entrada'])){$gdh_entrada = date('Y-m-d H:i', strtotime(str_replace('/', '-',$dados['gdh_entrada']))); $flag = "Entrou"; }
		if(!empty($dados['gdh_saida'])){$gdh_saida = date('Y-m-d H:i', strtotime(str_replace('/', '-',$dados['gdh_saida']))); $flag = "Saiu"; }
