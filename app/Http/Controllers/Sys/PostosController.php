...
class PostosController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		try{
			...
			switch($dados['tipo']){
				case "1": $posto->letra = "A"; $posto->tipo = "Oficial General"; $posto->ordem = 4; break;
				case "2": $posto->letra = "B"; $posto->tipo = "Oficiais Superiores"; $posto->ordem = 7; break;
				case "3": $posto->letra = "C"; $posto->tipo = "Oficiais Subalternos/Intermediarios"; $posto->ordem = 11; break;
				case "4": $posto->letra = "D"; $posto->tipo = "Praças"; $posto->ordem = 15; break;
				case "5": $posto->letra = "E"; $posto->tipo = "Praças"; $posto->ordem = 17; break;
				case "6": $posto->letra = "F"; $posto->tipo = "Civil"; $posto->ordem = 21; break;
			}
			$posto->save();
