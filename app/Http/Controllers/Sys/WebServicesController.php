	...
	*/
	...
	public function pesquisaPosto(Request $request)
	{
		...
		if(!empty($result)){
			...
			switch($result->letra)
			{
				case "A": $result->tipo = 1; break;
				case "B": $result->tipo = 2; break;
				case "C": $result->tipo = 3; break;
				case "D": $result->tipo = 4; break;
				case "E": $result->tipo = 5; break;
				case "F": $result->tipo = 6; break;
			}
			echo json_encode($result);
		}else{
