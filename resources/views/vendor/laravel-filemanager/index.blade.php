...
<body>
  <div class="container-fluid" id="wrapper">
    ...
    <div class="row">
      <div class="alert alert-sm alert-warning">Documentos Necessários: <b>Cópia da Identidade, Cópia da CNH e Cópia da CRLV</b></div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('unisharp.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
            ...
            @if (session('mil'))
            <input type='hidden' name='working_dir' id='working_dir' value="{{ base64_decode(session('mil')) }}">
            @else
  ...
  <script>
    ...
    Dropzone.options.uploadForm = {
      ...
      dictDefaultMessage: 'Ou arraste os arquivos aqui',
      init: function() {
