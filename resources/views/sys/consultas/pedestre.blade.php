...
@section('title', 'SIGAPS | Consulta Pedestres')
...
<div class="box box-default" style="border-top: 3px solid purple;">
	<div class="box-header">
		<h5 class="box-title"><i class="icon fa fa-search"></i> Consulta Pedestre</h5>
	</div>
	<div class="box-body">
		@if (session('error'))
		...
		@endif
		<table width="100%" cellspacing="0" class="table text-center table-compact table-condensed table-hover tb_pedestre">
			{{csrf_field()}}
			<thead>
